...
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
       ...
       Key = {"executedLOL637"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
...
local Button = Tab:CreateButton({
   Name = "hiding spot (might kill you a few times)",
   Callback = function()
      local CF = CFrame.new(688.053833, 48.0802345, 106.538811)
      local Speed = 110 --Studs Per Second
 ...
 local Button = Tab:CreateButton({
    Name = "inside police",
    Callback = function()
        local CF = CFrame.new(59.7082558, -4.47931051, 597.668518)
   ...
   Callback = function()
      ...
      local function toggle()
          ...
          if flying then 
              ...
              bodyVel.Name = "FlyVelocity" -- Name it FlyVelocity
...
local Button = Tab:CreateButton({
   Name = "player highlight(WARNING ONCE ITS ON U CANT TURN IT OFF)",
   Callback = function()
      _G.esp = true;
      ...
      for i,v in pairs(players) do
       ...
       esp.FillColor = Color3.new(1, 0.662697, 0)
...
local Button = Tab:CreateButton({
    Name = "swimhub good aimlock! and universal)",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/SwimPaste/swimhack/369f150459a7ea7d0a5de7a5af3358c77c2c1d5f/swimhub.lua", true))()
    end,
 })
